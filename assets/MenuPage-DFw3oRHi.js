import{u as _e,r as q,j as c,g as xn,R as Fe,L as An}from"./index-C-PNHt_t.js";const wn=({id:t,name:e,price:n,image:a,hasSpiceLevel:r=!1})=>{const{addToCart:i}=_e(),[s,o]=q.useState("No Spice"),u=()=>{i(r?`${e} (${s})`:e,n,a)};return c.jsxs("div",{className:"col-md-3 product",children:[c.jsx("img",{src:a,alt:e,width:"130px",height:"130px"}),c.jsxs("h5",{children:[e,c.jsx("br",{}),"฿",n]}),r&&c.jsxs("div",{className:"spice-level-container",children:[c.jsx("p",{children:"ระดับความเผ็ด:"}),c.jsxs("div",{className:"spice-selection",children:[c.jsxs("div",{className:"spice-option",children:[c.jsx("input",{type:"radio",id:`no-spice-${t}`,name:`spice-${t}`,value:"No Spice",checked:s==="No Spice",onChange:()=>o("No Spice")}),c.jsx("label",{htmlFor:`no-spice-${t}`,children:"ไม่เผ็ด"})]}),c.jsxs("div",{className:"spice-option",children:[c.jsx("input",{type:"radio",id:`mild-${t}`,name:`spice-${t}`,value:"Mild_Spicy",checked:s==="Mild_Spicy",onChange:()=>o("Mild_Spicy")}),c.jsxs("label",{htmlFor:`mild-${t}`,children:["เผ็ดน้อย ",c.jsx("img",{src:"icon/chili-pepper.png",alt:"Chili",className:"chili-icon",width:"20"})]})]}),c.jsxs("div",{className:"spice-option",children:[c.jsx("input",{type:"radio",id:`medium-${t}`,name:`spice-${t}`,value:"Medium_Spicy",checked:s==="Medium_Spicy",onChange:()=>o("Medium_Spicy")}),c.jsxs("label",{htmlFor:`medium-${t}`,children:["เผ็ดปานกลาง",c.jsx("img",{src:"/assets/icon/chili-pepper.png",alt:"Chili",className:"chili-icon",width:"20"}),c.jsx("img",{src:"/assetsicon/chili-pepper.png",alt:"Chili",className:"chili-icon",width:"20"})]})]}),c.jsxs("div",{className:"spice-option",children:[c.jsx("input",{type:"radio",id:`hot-${t}`,name:`spice-${t}`,value:"Hot_Spicy",checked:s==="Hot_Spicy",onChange:()=>o("Hot_Spicy")}),c.jsxs("label",{htmlFor:`hot-${t}`,children:["เผ็ดมาก",c.jsx("img",{src:"/assetsicon/chili-pepper.png",alt:"Chili",className:"chili-icon",width:"20"}),c.jsx("img",{src:"/assetsicon/chili-pepper.png",alt:"Chili",className:"chili-icon",width:"20"}),c.jsx("img",{src:"/assetsicon/chili-pepper.png",alt:"Chili",className:"chili-icon",width:"20"})]})]})]})]}),c.jsx("button",{className:"btn btn-primary add-to-cart",style:r?{backgroundColor:"#561C24",color:"white",borderColor:"#561C24"}:{},"data-product-id":e,"data-price":n,onClick:u,children:"Add to Cart"})]})};/*!
